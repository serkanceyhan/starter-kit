    ...
    <div class="max-w-[1280px] mx-auto px-6">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div class="col-span-1 md:col-span-1">
                <div class="mb-6">
                    <img alt="Tamirat Logo" class="h-8 w-auto object-contain" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCL0Ux4Xs6k2OJMKMUgBkKHQEuyjl2LOpicn9nENU_zTyXiVeTv75FwZHISFozvtmyaGsmFQ62mLwjwieHs0oMR3Trk3_GdhLkHmcfPIIs6dTuZdy2piKAi00g2r8oHkF5pNiDwZfbxDRdoOJi-D6MOmq9mvZB9wT4z_1QyS0Dy66uBW2Gpd0_0m-Lb4KGqNqLGuPDquAYmOmAE7Ez6wCaRumVq8Vd7eU-ahoJl-3Nu9zdlOzNa21wucXYxP0HsbveIYfTmr7zz464"/>
                </div>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm text-gray-500 dark:text-gray-400">
                    <li><a class="hover:text-primary" href="#">Kumaş Döşeme</a></li>
                    <li><a class="hover:text-primary" href="#">Masa Cilalama</a></li>
                    <li><a class="hover:text-primary" href="#">Mekanizma Tamiri</a></li>
                    <li><a class="hover:text-primary" href="#">Ofis Taşıma</a></li>
                </ul>
            </div>
            <div>
        ...
        <div class="border-t border-gray-200 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
            <p class="text-xs text-gray-400">© 2024 Tamirat. Tüm hakları saklıdır.</p>
